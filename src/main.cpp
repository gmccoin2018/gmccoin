...
int64_t nTargetSpacing = 2 * 60;  // Time between reward:    120 Second
...
const string strMessageMagic = "gmccoin Signed Message:\n";
...
// miner's coin base reward premine -- Premined: 30.000.000
int64_t GetProofOfWorkReward(int64_t nFees)
{
        ...
        if (pindexBest->nHeight+1 > 3 && pindexBest->nHeight+1<=3000000)
            nSubsidy = 30 * COIN;
        
        if (pindexBest->nHeight+1 > 3000000)
            nSubsidy = 15 * COIN;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "gmccoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "gmccoin.com Block";
        CTransaction txNew;
        txNew.nTime = 1511434800;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1511434800;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2324805;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xdcfae03418337a84402dedc80af1af04bb3ccd107c3eb1c8f1bfb563f1dd16db"));
        block.print();
